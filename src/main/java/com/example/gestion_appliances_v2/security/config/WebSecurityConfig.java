package com.example.gestion_appliances_v2.security.config;

import com.example.gestion_appliances_v2.security.common.AuthoritiesConstants;
import com.example.gestion_appliances_v2.security.jwt.JWTAuthenticationFilter;
import com.example.gestion_appliances_v2.security.jwt.JWTAuthorizationFiler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/actuator/info").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/manager/login").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/manager/").hasAnyAuthority(AuthoritiesConstants.MANAGER);

package com.example.gestion_appliances_v2.security.jwt;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.example.gestion_appliances_v2.GestionAppliancesV2Application;
import com.example.gestion_appliances_v2.security.bean.User;
import com.example.gestion_appliances_v2.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = GestionAppliancesV2Application.getCtx().getBean(UserService.class);

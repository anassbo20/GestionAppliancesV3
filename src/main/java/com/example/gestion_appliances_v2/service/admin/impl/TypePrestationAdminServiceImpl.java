...
@Service
public class TypePrestationAdminServiceImpl extends AbstractServiceImpl<TypePrestation> implements TypePrestationAdminService {
    @Autowired
    ...
    @Override
    public TypePrestation archiver(TypePrestation typePrestation) {
        if (typePrestation.getArchive() == null) {
            typePrestation.setArchive(false);
        }
        typePrestation.setArchive(true);
        typePrestation.setDateArchivage(new Date());
        typePrestationDao.save(typePrestation);
        return typePrestation;
    }

    @Override
    public TypePrestation desarchiver(TypePrestation typePrestation) {
        if (typePrestation.getArchive() == null) {
            typePrestation.setArchive(false);
        }
        typePrestation.setArchive(false);
        typePrestation.setDateArchivage(null);
        typePrestationDao.save(typePrestation);
        return typePrestation;
    }
    ...
    private void deleteAssociatedLists(Long id) {
        if (id != null) {
            ...
            suiviAdminService.deleteByTypePrestationId(id);
        }
    }
}

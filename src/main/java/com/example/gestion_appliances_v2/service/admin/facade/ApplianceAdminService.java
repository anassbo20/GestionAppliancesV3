...
public interface ApplianceAdminService extends AbstractService<Appliance,Long, ApplianceVo> {
    ...
    Appliance archiver(Appliance appliance) ;

    Appliance desarchiver(Appliance appliance);

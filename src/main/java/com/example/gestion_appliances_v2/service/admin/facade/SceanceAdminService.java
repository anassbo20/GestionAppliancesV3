...
public interface SceanceAdminService extends AbstractService<Sceance,Long, SceanceVo> {
        ...
        Sceance archiver(Sceance sceance) ;

        Sceance desarchiver(Sceance sceance);
